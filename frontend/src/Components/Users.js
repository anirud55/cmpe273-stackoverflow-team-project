              ...
              <Row className="tags_search_btn_group">
                ...
                <Col md={6}>
                  <div className='tags_button_group'>
                    <Button className='Home_Questions_Col_Tabs_Filter_Button' variant="light">Reputation</Button>
                    <Button className='Home_Questions_Col_Tabs_Filter_Button' variant="light">New Users</Button>
                    <Button className='Home_Questions_Col_Tabs_Filter_Button' variant="light">Voters</Button>
                    <Button className='Home_Questions_Col_Tabs_Filter_Button' variant="light">Editors</Button>
                    <Button className='Home_Questions_Col_Tabs_Filter_Button' variant="light">Moderators</Button>
                  </div>
                </Col>
              </Row>
            </Col>
